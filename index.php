...
<body>
    ...
    <main>
        ...
        <section>
            <div class="container">
                <h2>Выводы</h2>
                <p><span>==</span> - оператор гибкого сравнения (равенства), сравнивает значения операндов после приведения типов (<a href="https://www.php.net/manual/ru/types.comparisons.php" target="_blank">Таблицы</a>)</p>
                <p><span>===</span> - оператор жёсткого сравнения (идентичности), сравнивает значения операндов и их типы. Чтобы получить "true" типы сравниваемых переменных и их значения должны совпадать.</p>
            </div>
        </section>
    </main>
